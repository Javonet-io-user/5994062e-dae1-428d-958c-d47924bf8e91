...
public class SegmentPositionNode extends Node {
  ...
  public List<java.lang.Integer> getValues() {
    try {
      return new List<java.lang.Integer>((NObject) javonetHandle.<NObject>get("Values"));
  ...
  public ElementPosition getElementPosition() {
    try {
      return new ElementPosition((NObject) javonetHandle.<NObject>get("ElementPosition"));
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
      return null;
    }
